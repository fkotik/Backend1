                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <?php if(\Illuminate\Support\Facades\Auth::user()->login=='admin'): ?>
                                        ...
                                        <form id="admin-form" action="<?php echo e(route('admin')); ?>" method="GET" class="d-none">
                                            <?php echo csrf_field(); ?>
                                        </form>
                                    <?php endif; ?>
...
<?php /**PATH C:\OSPanel\domains\localhost\resources\views/layouts/app.blade.php ENDPATH**/ ?>